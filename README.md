<div align=center><h1> Marcat Project </h1></div>
...
#### 웹사이트 대표 캐릭터의 이미지와 연관지어서 

#### 사용자에게 마켓에 브랜딩을 각인하고자 하는 의미입니다. <br><br><br>
...
### 보완하면 좋을 부분
#### - 프로젝트 이름에 걸맞게 고양이 관련 상품에 대한 이벤트나 주력 상품을 배치.
#### - 쪽지 기능을 실시간 채팅방 느낌으로 바꾸면 UI나 사용성이 좋아질 것 같음.

### 아쉬운 점
#### - 팀원간의 코딩 스타일 일관성을 최대한 맞추려하였지만 쉽지 않았음.
#### - 초기 계획에서 여러 이슈나 팀원과의 합의된 판단으로 중간 중간 기획이 다급하게 바뀜.

### 시도하면 좋을 부분
#### - ORM을 JPA로 바꿔서 적용하는 부분
